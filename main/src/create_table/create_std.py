...
def call_center():
    ...
    log_path="/Workspace/Users/bdr83175@gmail.com/ETL-Pipelines-using-Databricks/main/logs/create_table/std.log"
    logger=get_logger("Table Creation", log_path)
    logger.info("Creating SparkSession..................")
    spark=SparkSession.builder.appName("call_center").getOrCreate()
    lst=["call_center", "catalog_sales", "cust_demographics", "income",  "store",  
    ...
    for file_name in lst:
        ...
        src_path=f"/Workspace/Users/bdr83175@gmail.com/ETL-Pipelines-using-Databricks/main/src/ddl/std/{file_name}.sql"
